...
class PureByteJEPA(nn.Module):
    def __init__(
        ...
        *,
        ...
        if self.contextual_target or self.contextual_aux_weight > 0.0 or self.target_source in {"contextual_only", "contextual_delta", "rotation_scale_delta", "sphere_delta", "additive_delta"}:
