...
class Hyperparameters:
    ...
    predictor_style = os.environ.get("PREDICTOR_STYLE", "direct")
    action_dim = int(os.environ.get("ACTION_DIM", 64))
    transition_hidden_dim = int(os.environ.get("TRANSITION_HIDDEN_DIM", os.environ.get("PREDICTOR_HIDDEN_DIM", "512")))
    ...
    target_encoder_mode = os.environ.get("TARGET_ENCODER_MODE", "ema")
    target_stop_grad = bool(int(os.environ.get("TARGET_STOP_GRAD", "1")))
    ...
    lm_probe_hidden_dim = int(os.environ.get("LM_PROBE_HIDDEN_DIM", 0))
    encoder_unet_skip = bool(int(os.environ.get("ENCODER_UNET_SKIP", "0")))
    encoder_unet_skip_init = float(os.environ.get("ENCODER_UNET_SKIP_INIT", "1.0"))
    target_future_steps = int(os.environ.get("TARGET_FUTURE_STEPS", 1))
    aux_target_future_steps = os.environ.get("AUX_TARGET_FUTURE_STEPS", "")
    aux_target_weight = float(os.environ.get("AUX_TARGET_WEIGHT", 0.0))
    contextual_delta_normalization = os.environ.get("CONTEXTUAL_DELTA_NORMALIZATION", "normalized")
    contextual_delta_reference = os.environ.get("CONTEXTUAL_DELTA_REFERENCE", "anchor")
    contextual_delta_whitening = os.environ.get("CONTEXTUAL_DELTA_WHITENING", "none")
    contextual_delta_whiten_eps = float(os.environ.get("CONTEXTUAL_DELTA_WHITEN_EPS", 1e-4))
    contextual_delta_span = int(os.environ.get("CONTEXTUAL_DELTA_SPAN", 1))
    contextual_delta_remove_topk = int(os.environ.get("CONTEXTUAL_DELTA_REMOVE_TOPK", 0))
    contextual_delta_l1_weight = float(os.environ.get("CONTEXTUAL_DELTA_L1_WEIGHT", 0.0))
    contextual_state_projector = os.environ.get("CONTEXTUAL_STATE_PROJECTOR", "none")
    contextual_delta_parallel_weight = float(os.environ.get("CONTEXTUAL_DELTA_PARALLEL_WEIGHT", 0.0))
    contextual_delta_magnitude_weight = float(os.environ.get("CONTEXTUAL_DELTA_MAGNITUDE_WEIGHT", 0.0))
    contextual_delta_teacher_orth_weight = float(os.environ.get("CONTEXTUAL_DELTA_TEACHER_ORTH_WEIGHT", 0.0))
    contextual_delta_contrastive_teacher_anchor = bool(
        int(os.environ.get("CONTEXTUAL_DELTA_CONTRASTIVE_TEACHER_ANCHOR", "0"))
    )
    rotation_delta_loss_target = os.environ.get("ROTATION_DELTA_LOSS_TARGET", "diff")
    additive_delta_normalization = os.environ.get("ADDITIVE_DELTA_NORMALIZATION", "none")
    contrastive_weight = float(os.environ.get("CONTRASTIVE_WEIGHT", 0.0))
    contrastive_temperature = float(os.environ.get("CONTRASTIVE_TEMPERATURE", 0.1))
    contrastive_samples = int(os.environ.get("CONTRASTIVE_SAMPLES", 4096))
    contrastive_future_steps = int(os.environ.get("CONTRASTIVE_FUTURE_STEPS", 1))
    contrastive_mode = os.environ.get("CONTRASTIVE_MODE", "delta")
    ...
    target_var_reg_weight = float(os.environ.get("TARGET_VAR_REG_WEIGHT", 0.0))
    target_cov_reg_weight = float(os.environ.get("TARGET_COV_REG_WEIGHT", 0.0))
...
def main() -> None:
    ...
    base_model = PureByteJEPA(
        ...
        predictor_style=args.predictor_style,
        ...
        lm_probe_hidden_dim=args.lm_probe_hidden_dim,
        encoder_unet_skip=args.encoder_unet_skip,
        encoder_unet_skip_init=args.encoder_unet_skip_init,
        target_future_steps=args.target_future_steps,
        aux_target_future_steps=args.aux_target_future_steps,
        aux_target_weight=args.aux_target_weight,
        contextual_delta_normalization=args.contextual_delta_normalization,
        contextual_delta_reference=args.contextual_delta_reference,
        contextual_delta_whitening=args.contextual_delta_whitening,
        contextual_delta_whiten_eps=args.contextual_delta_whiten_eps,
        contextual_delta_span=args.contextual_delta_span,
        contextual_delta_remove_topk=args.contextual_delta_remove_topk,
        contextual_delta_l1_weight=args.contextual_delta_l1_weight,
        contextual_state_projector=args.contextual_state_projector,
        contextual_delta_parallel_weight=args.contextual_delta_parallel_weight,
        contextual_delta_magnitude_weight=args.contextual_delta_magnitude_weight,
        contextual_delta_teacher_orth_weight=args.contextual_delta_teacher_orth_weight,
        contextual_delta_contrastive_teacher_anchor=args.contextual_delta_contrastive_teacher_anchor,
        rotation_delta_loss_target=args.rotation_delta_loss_target,
        additive_delta_normalization=args.additive_delta_normalization,
        contrastive_weight=args.contrastive_weight,
        contrastive_temperature=args.contrastive_temperature,
        contrastive_samples=args.contrastive_samples,
        contrastive_future_steps=args.contrastive_future_steps,
        contrastive_mode=args.contrastive_mode,
        var_reg_weight=args.var_reg_weight,
        cov_reg_weight=args.cov_reg_weight,
        target_var_reg_weight=args.target_var_reg_weight,
        target_cov_reg_weight=args.target_cov_reg_weight,
    ).to(device)
